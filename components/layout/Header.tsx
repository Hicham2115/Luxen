      ...
      <div className="mx-auto flex h-16 max-w-[1270px] items-center justify-between gap-4 px-5 sm:h-20 sm:px-8 lg:h-16 lg:px-0">
        ...
        >
          ...
          <span className="flex flex-col leading-none">
            <span className="text-[20px] font-extrabold tracking-[0.04em] text-[#08285a] sm:text-[24px] lg:text-[20px]">
              LUXEN
            </span>
            <span className="mt-1 text-[9px] font-semibold uppercase tracking-[0.25em] text-gold-600 sm:text-[10px]">
          ...
          {navLinks.map((link, index) => (
            <Link
              ...
              className={cn(
                ...
                index === 0
                  ? "text-marino-500"
                  : "text-[#071d4d] hover:text-marino-500",
              )}
            >
              {link.label}
              <span
        ...
        <div className="flex items-center gap-3 sm:gap-4 lg:hidden">
          ...
          >
            {isMenuOpen ? (
              <X aria-hidden="true" className="h-6 w-6 sm:h-7 sm:w-7" />
            ) : (
              <Menu aria-hidden="true" className="h-6 w-6 sm:h-7 sm:w-7" />
            )}
          </button>
        </div>
      </div>
