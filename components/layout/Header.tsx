...
export function Header() {
  ...
  return (
    <header className="relative z-50 bg-white shadow-[0_1px_0_rgba(6,38,90,0.06),0_12px_30px_-18px_rgba(6,38,90,0.3)]">
      ...
      <div className="mx-auto flex h-16 max-w-[1270px] items-center justify-between gap-4 px-5 sm:h-20 sm:px-8 lg:h-16 lg:px-0">
        <Link href="/" className="flex items-center gap-3" aria-label="Luxen, accueil">
          ...
          <span className="flex flex-col leading-none">
            ...
            <span className="mt-1 text-[9px] font-semibold uppercase tracking-[0.25em] text-gold-600 sm:text-[10px]">Plomberie Premium</span>
          </span>
        </Link>
