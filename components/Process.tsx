    ...
    <section className="relative isolate overflow-hidden bg-white px-5 py-16 sm:px-8 sm:py-20 lg:py-24">
      ...
      <div className="mx-auto max-w-[1270px]">
        ...
        <motion.div
          ...
          <div className="text-center"><a href="tel:+34602838607" className="inline-flex h-12 items-center gap-3 rounded-lg bg-marino-500 px-7 text-[17px] font-semibold text-white shadow-[0_8px_18px_rgba(20,40,80,0.23)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-marino-600 hover:shadow-[0_12px_24px_rgba(20,40,80,0.32)]"><Phone aria-hidden="true" className="h-5 w-5" />+34 602 83 86 07</a><p className="mt-2 text-[14px] font-medium text-marino-500">Llámenos ahora</p></div>
        </motion.div>
      </div>
    </section>
  );
