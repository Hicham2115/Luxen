      ...
      <div className="mx-auto max-w-[1270px]">
        ...
        <div className="mt-24 grid gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-18">
          {steps.map(({ icon: Icon, number, title, description }, index) => (
            <article key={number} className="group relative min-h-[345px] rounded-xl border border-[#e4ebf3] bg-white px-7 pb-7 pt-[62px] text-center shadow-[0_8px_20px_rgba(11,49,96,0.08)] transition-all duration-300 hover:-translate-y-2 hover:border-sky-200 hover:shadow-[0_18px_35px_rgba(12,87,158,0.15)]">
              ...
              <p className="text-[28px] font-extrabold leading-none text-amber-500">{number}</p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-6 rounded-xl bg-[#edf8ff] px-7 py-5 text-center lg:flex-row lg:text-left">
