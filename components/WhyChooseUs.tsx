...
export function WhyChooseUs() {
  return (
    <section id="about" className="overflow-hidden bg-[#fff] px-5 py-20 sm:px-8 lg:py-24">
      <div className="mx-auto max-w-[1270px]">
        <div className="relative min-h-[360px] lg:min-h-[385px]">
          <div className="relative z-10 max-w-[780px] pt-4">
          ...
          <div className="relative mt-10 h-[330px] lg:absolute lg:-right-8 lg:-top-24 lg:mt-0 lg:h-[545px] lg:w-[620px]">
        ...
        <div className="relative z-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {benefits.map(({ icon: Icon, title, description }) => (
            <article key={title} className="group min-h-[350px] rounded-xl border border-[#e4ebf3] bg-white px-5 py-6 text-center shadow-[0_8px_18px_rgba(11,49,96,0.07)] transition-all duration-300 hover:-translate-y-2 hover:border-sky-200 hover:shadow-[0_18px_35px_rgba(12,87,158,0.15)]">
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-6 rounded-xl bg-[#edf8ff] px-7 py-5 text-center lg:flex-row lg:text-left">
